...
describe "Items API" do
  ...
  context "GET /api/v1/items"
    ...
    context "GET /items/find?description=Dangerous"
      it "sends data on an item meeting the search criteria" do
        Item.create(id: 5, name: "Kunai", description: "Dangerous", merchant_id: Merchant.first.id)
    ...
    context "GET /items/find_all?description=Dangerous"
      it "sends data on an item meeting the search criteria" do
        Item.create(id: 5, name: "Kunai", description: "Dangerous", merchant_id: Merchant.first.id)
        Item.create(id: 6, name: "Smoke Ball", description: "Dangerous", merchant_id: Merchant.first.id)
    ...
    context "GET /items/find?unit_price=10000"
      it "sends data on an item meeting the search criteria" do
